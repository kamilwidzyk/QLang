...
\input{chapter-8-debugging/qlang/debug_demo.tex}
...
\input{chapter-8-debugging/qlang/packet-log.tex}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=1.0\textwidth]{img/packet_log.png}
    \caption{Output of the packet logging example in the interpreter and place consoles.}
    \label{fig:packet_log_output}
\end{figure}
