...
from ...operations.operators import do_operation_pow
...
def handle_pow_eq_op(self: Place, block: Any, parent: Any, pos: ScriptErrors.Position):
    """
    Handles compound power operation
    ||| expr '**=' expr
    ...
    if not is_variable_expression(left_expr):
        # code ATE-8
        raise AssignmentToExpressionException(ScriptErrors.Position.extract(left_expr), code="8")
